...
# [面试题 16.21. Sum Swap LCCI](https://leetcode.cn/problems/sum-swap-lcci)
 ### Description
...
**Related Topics**  [Array](https://leetcode.cn/tag/array) [Hash Table](https://leetcode.cn/tag/hash-table) [Binary Search](https://leetcode.cn/tag/binary-search) [Sorting](https://leetcode.cn/tag/sorting) 