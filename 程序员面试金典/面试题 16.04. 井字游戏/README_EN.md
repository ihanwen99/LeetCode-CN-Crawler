...
# [面试题 16.04. Tic-Tac-Toe LCCI](https://leetcode.cn/problems/tic-tac-toe-lcci)
 ### Description
...
**Related Topics**  [Array](https://leetcode.cn/tag/array) [Counting](https://leetcode.cn/tag/counting) [Matrix](https://leetcode.cn/tag/matrix) 