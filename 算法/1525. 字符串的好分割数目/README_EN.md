...
# [1525. Number of Good Ways to Split a String](https://leetcode.cn/problems/number-of-good-ways-to-split-a-string)
 ### Description
...
**Related Topics**  [Bit Manipulation](https://leetcode.cn/tag/bit-manipulation) [String](https://leetcode.cn/tag/string) [Dynamic Programming](https://leetcode.cn/tag/dynamic-programming) 