...
**Related Topics**  [Queue](https://leetcode.cn/tag/queue) [Array](https://leetcode.cn/tag/array) [Dynamic Programming](https://leetcode.cn/tag/dynamic-programming) [Sliding Window](https://leetcode.cn/tag/sliding-window) [Monotonic Queue](https://leetcode.cn/tag/monotonic-queue) [Heap (Priority Queue)](https://leetcode.cn/tag/heap-priority-queue) 