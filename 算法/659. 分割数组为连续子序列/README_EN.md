...
**Related Topics**  [Greedy](https://leetcode.cn/tag/greedy) [Array](https://leetcode.cn/tag/array) [Hash Table](https://leetcode.cn/tag/hash-table) [Heap (Priority Queue)](https://leetcode.cn/tag/heap-priority-queue) 
