...
# [2038. Remove Colored Pieces if Both Neighbors are the Same Color](https://leetcode.cn/problems/remove-colored-pieces-if-both-neighbors-are-the-same-color)
 ### Description
...
**Related Topics**  [Greedy](https://leetcode.cn/tag/greedy) [Math](https://leetcode.cn/tag/math) [String](https://leetcode.cn/tag/string) [Game Theory](https://leetcode.cn/tag/game-theory) 