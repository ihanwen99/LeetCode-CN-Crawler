...
# [2259. Remove Digit From Number to Maximize Result](https://leetcode.cn/problems/remove-digit-from-number-to-maximize-result)
 ### Description
...
**Related Topics**  [Greedy](https://leetcode.cn/tag/greedy) [String](https://leetcode.cn/tag/string) [Enumeration](https://leetcode.cn/tag/enumeration) 