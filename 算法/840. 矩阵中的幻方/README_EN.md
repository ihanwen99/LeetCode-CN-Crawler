...
# [840. Magic Squares In Grid](https://leetcode.cn/problems/magic-squares-in-grid)
 ### Description
...
**Related Topics**  [Array](https://leetcode.cn/tag/array) [Math](https://leetcode.cn/tag/math) [Matrix](https://leetcode.cn/tag/matrix) 