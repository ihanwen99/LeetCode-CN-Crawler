...
**标签:**  [广度优先搜索](https://leetcode.cn/tag/breadth-first-search) [线段树](https://leetcode.cn/tag/segment-tree) [数组](https://leetcode.cn/tag/array) [动态规划](https://leetcode.cn/tag/dynamic-programming) 