...
**Related Topics**  [Reservoir Sampling](https://leetcode.cn/tag/reservoir-sampling) [Array](https://leetcode.cn/tag/array) [Math](https://leetcode.cn/tag/math) [Binary Search](https://leetcode.cn/tag/binary-search) [Ordered Set](https://leetcode.cn/tag/ordered-set) [Prefix Sum](https://leetcode.cn/tag/prefix-sum) [Randomized](https://leetcode.cn/tag/randomized) 
