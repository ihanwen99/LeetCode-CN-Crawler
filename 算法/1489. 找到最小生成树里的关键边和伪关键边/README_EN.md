...
**Related Topics**  [Union Find](https://leetcode.cn/tag/union-find) [Graph](https://leetcode.cn/tag/graph) [Minimum Spanning Tree](https://leetcode.cn/tag/minimum-spanning-tree) [Sorting](https://leetcode.cn/tag/sorting) [Strongly Connected Component](https://leetcode.cn/tag/strongly-connected-component) 