...
# [2018. Check if Word Can Be Placed In Crossword](https://leetcode.cn/problems/check-if-word-can-be-placed-in-crossword)
 ### Description
...
**Related Topics**  [Array](https://leetcode.cn/tag/array) [Enumeration](https://leetcode.cn/tag/enumeration) [Matrix](https://leetcode.cn/tag/matrix) 