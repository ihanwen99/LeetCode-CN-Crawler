...
# [2424. Longest Uploaded Prefix](https://leetcode.cn/problems/longest-uploaded-prefix)
 ### Description
...
**Related Topics**  [Union Find](https://leetcode.cn/tag/union-find) [Design](https://leetcode.cn/tag/design) [Binary Indexed Tree](https://leetcode.cn/tag/binary-indexed-tree) [Segment Tree](https://leetcode.cn/tag/segment-tree) [Binary Search](https://leetcode.cn/tag/binary-search) [Ordered Set](https://leetcode.cn/tag/ordered-set) [Heap (Priority Queue)](https://leetcode.cn/tag/heap-priority-queue) 