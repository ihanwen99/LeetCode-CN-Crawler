...
**Related Topics**  [Design](https://leetcode.cn/tag/design) [Hash Table](https://leetcode.cn/tag/hash-table) [Linked List](https://leetcode.cn/tag/linked-list) [Heap (Priority Queue)](https://leetcode.cn/tag/heap-priority-queue) 