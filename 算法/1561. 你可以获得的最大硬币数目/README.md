...
**标签:**  [贪心](https://leetcode.cn/tag/greedy) [数组](https://leetcode.cn/tag/array) [数学](https://leetcode.cn/tag/math) [博弈](https://leetcode.cn/tag/game-theory) [排序](https://leetcode.cn/tag/sorting) 
# 解题思路 √
