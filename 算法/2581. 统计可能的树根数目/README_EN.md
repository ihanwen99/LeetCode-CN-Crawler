...
# [2581. Count Number of Possible Root Nodes](https://leetcode.cn/problems/count-number-of-possible-root-nodes)
 ### Description
...
**Related Topics**  [Tree](https://leetcode.cn/tag/tree) [Depth-First Search](https://leetcode.cn/tag/depth-first-search) [Hash Table](https://leetcode.cn/tag/hash-table) [Dynamic Programming](https://leetcode.cn/tag/dynamic-programming) 