...
# [2662. Minimum Cost of a Path With Special Roads](https://leetcode.cn/problems/minimum-cost-of-a-path-with-special-roads)
 ### Description
...
**Related Topics**  [Graph](https://leetcode.cn/tag/graph) [Array](https://leetcode.cn/tag/array) [Shortest Path](https://leetcode.cn/tag/shortest-path) [Heap (Priority Queue)](https://leetcode.cn/tag/heap-priority-queue) 