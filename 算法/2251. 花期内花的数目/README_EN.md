...
**Related Topics**  [Array](https://leetcode.cn/tag/array) [Hash Table](https://leetcode.cn/tag/hash-table) [Binary Search](https://leetcode.cn/tag/binary-search) [Ordered Set](https://leetcode.cn/tag/ordered-set) [Prefix Sum](https://leetcode.cn/tag/prefix-sum) [Sorting](https://leetcode.cn/tag/sorting) 