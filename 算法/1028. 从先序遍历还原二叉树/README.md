...
**标签:**  [树](https://leetcode.cn/tag/tree) [深度优先搜索](https://leetcode.cn/tag/depth-first-search) [字符串](https://leetcode.cn/tag/string) [二叉树](https://leetcode.cn/tag/binary-tree) 
# 解题思路 √
