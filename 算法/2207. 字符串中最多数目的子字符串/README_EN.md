...
# [2207. Maximize Number of Subsequences in a String](https://leetcode.cn/problems/maximize-number-of-subsequences-in-a-string)
 ### Description
...
**Related Topics**  [Greedy](https://leetcode.cn/tag/greedy) [String](https://leetcode.cn/tag/string) [Prefix Sum](https://leetcode.cn/tag/prefix-sum) 