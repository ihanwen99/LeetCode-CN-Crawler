...
**Related Topics**  [Stack](https://leetcode.cn/tag/stack) [Array](https://leetcode.cn/tag/array) [Binary Search](https://leetcode.cn/tag/binary-search) [Sorting](https://leetcode.cn/tag/sorting) [Monotonic Stack](https://leetcode.cn/tag/monotonic-stack) [Heap (Priority Queue)](https://leetcode.cn/tag/heap-priority-queue) 