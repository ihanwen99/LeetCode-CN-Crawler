...
**Related Topics**  [Binary Indexed Tree](https://leetcode.cn/tag/binary-indexed-tree) [Array](https://leetcode.cn/tag/array) [Binary Search](https://leetcode.cn/tag/binary-search) 