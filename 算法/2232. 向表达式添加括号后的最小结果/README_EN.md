...
# [2232. Minimize Result by Adding Parentheses to Expression](https://leetcode.cn/problems/minimize-result-by-adding-parentheses-to-expression)
 ### Description
...
**Related Topics**  [String](https://leetcode.cn/tag/string) [Enumeration](https://leetcode.cn/tag/enumeration) 