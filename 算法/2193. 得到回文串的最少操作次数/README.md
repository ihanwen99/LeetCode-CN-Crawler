...
**标签:**  [贪心](https://leetcode.cn/tag/greedy) [树状数组](https://leetcode.cn/tag/binary-indexed-tree) [双指针](https://leetcode.cn/tag/two-pointers) [字符串](https://leetcode.cn/tag/string) 
# 解题思路 √
