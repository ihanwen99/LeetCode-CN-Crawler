...
**Related Topics**  [Greedy](https://leetcode.cn/tag/greedy) [Binary Indexed Tree](https://leetcode.cn/tag/binary-indexed-tree) [Two Pointers](https://leetcode.cn/tag/two-pointers) [String](https://leetcode.cn/tag/string) 