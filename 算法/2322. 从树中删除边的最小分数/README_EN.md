...
**Related Topics**  [Bit Manipulation](https://leetcode.cn/tag/bit-manipulation) [Tree](https://leetcode.cn/tag/tree) [Depth-First Search](https://leetcode.cn/tag/depth-first-search) [Array](https://leetcode.cn/tag/array) 