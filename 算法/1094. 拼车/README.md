...
**标签:**  [数组](https://leetcode.cn/tag/array) [前缀和](https://leetcode.cn/tag/prefix-sum) [排序](https://leetcode.cn/tag/sorting) [模拟](https://leetcode.cn/tag/simulation) [堆（优先队列）](https://leetcode.cn/tag/heap-priority-queue) 