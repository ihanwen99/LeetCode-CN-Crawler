...
# [2528. Maximize the Minimum Powered City](https://leetcode.cn/problems/maximize-the-minimum-powered-city)
 ### Description
...
**Related Topics**  [Greedy](https://leetcode.cn/tag/greedy) [Queue](https://leetcode.cn/tag/queue) [Array](https://leetcode.cn/tag/array) [Binary Search](https://leetcode.cn/tag/binary-search) [Prefix Sum](https://leetcode.cn/tag/prefix-sum) [Sliding Window](https://leetcode.cn/tag/sliding-window) 