...
# [2451. Odd String Difference](https://leetcode.cn/problems/odd-string-difference)
 ### Description
...
**Related Topics**  [Hash Table](https://leetcode.cn/tag/hash-table) [Math](https://leetcode.cn/tag/math) [String](https://leetcode.cn/tag/string) 