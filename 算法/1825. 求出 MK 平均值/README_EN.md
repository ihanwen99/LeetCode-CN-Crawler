...
**Related Topics**  [Design](https://leetcode.cn/tag/design) [Queue](https://leetcode.cn/tag/queue) [Data Stream](https://leetcode.cn/tag/data-stream) [Ordered Set](https://leetcode.cn/tag/ordered-set) [Heap (Priority Queue)](https://leetcode.cn/tag/heap-priority-queue) 