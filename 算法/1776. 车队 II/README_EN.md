...
**Related Topics**  [Stack](https://leetcode.cn/tag/stack) [Array](https://leetcode.cn/tag/array) [Math](https://leetcode.cn/tag/math) [Monotonic Stack](https://leetcode.cn/tag/monotonic-stack) [Heap (Priority Queue)](https://leetcode.cn/tag/heap-priority-queue) 