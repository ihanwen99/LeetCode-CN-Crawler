...
**标签:**  [位运算](https://leetcode.cn/tag/bit-manipulation) [线段树](https://leetcode.cn/tag/segment-tree) [数组](https://leetcode.cn/tag/array) [二分查找](https://leetcode.cn/tag/binary-search) 
# 解题思路 √
