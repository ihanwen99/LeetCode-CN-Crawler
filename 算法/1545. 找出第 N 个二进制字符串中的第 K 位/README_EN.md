...
# [1545. Find Kth Bit in Nth Binary String](https://leetcode.cn/problems/find-kth-bit-in-nth-binary-string)
 ### Description
...
**Related Topics**  [Recursion](https://leetcode.cn/tag/recursion) [String](https://leetcode.cn/tag/string) 