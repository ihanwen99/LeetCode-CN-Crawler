...
**Related Topics**  [Greedy](https://leetcode.cn/tag/greedy) [Binary Indexed Tree](https://leetcode.cn/tag/binary-indexed-tree) [Segment Tree](https://leetcode.cn/tag/segment-tree) [String](https://leetcode.cn/tag/string) 