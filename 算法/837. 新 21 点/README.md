...
**标签:**  [数学](https://leetcode.cn/tag/math) [动态规划](https://leetcode.cn/tag/dynamic-programming) [滑动窗口](https://leetcode.cn/tag/sliding-window) [概率与统计](https://leetcode.cn/tag/probability-and-statistics) 