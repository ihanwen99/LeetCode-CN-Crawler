...
**Related Topics**  [Depth-First Search](https://leetcode.cn/tag/depth-first-search) [Graph](https://leetcode.cn/tag/graph) [Eulerian Circuit](https://leetcode.cn/tag/eulerian-circuit) 