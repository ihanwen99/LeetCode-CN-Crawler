...
**标签:**  [贪心](https://leetcode.cn/tag/greedy) [记忆化搜索](https://leetcode.cn/tag/memoization) [字符串](https://leetcode.cn/tag/string) [动态规划](https://leetcode.cn/tag/dynamic-programming) 