...
**Related Topics**  [Stack](https://leetcode.cn/tag/stack) [Memoization](https://leetcode.cn/tag/memoization) [Array](https://leetcode.cn/tag/array) [Math](https://leetcode.cn/tag/math) [String](https://leetcode.cn/tag/string) [Dynamic Programming](https://leetcode.cn/tag/dynamic-programming) 