...
# [2440. Create Components With Same Value](https://leetcode.cn/problems/create-components-with-same-value)
 ### Description
...
**Related Topics**  [Tree](https://leetcode.cn/tag/tree) [Depth-First Search](https://leetcode.cn/tag/depth-first-search) [Array](https://leetcode.cn/tag/array) [Math](https://leetcode.cn/tag/math) [Enumeration](https://leetcode.cn/tag/enumeration) 