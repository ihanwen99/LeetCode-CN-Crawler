...
**标签:**  [树](https://leetcode.cn/tag/tree) [深度优先搜索](https://leetcode.cn/tag/depth-first-search) [数组](https://leetcode.cn/tag/array) [数学](https://leetcode.cn/tag/math) [枚举](https://leetcode.cn/tag/enumeration) 