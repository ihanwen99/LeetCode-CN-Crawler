...
**Related Topics**  [Trie](https://leetcode.cn/tag/trie) [Two Pointers](https://leetcode.cn/tag/two-pointers) [String](https://leetcode.cn/tag/string) [String Matching](https://leetcode.cn/tag/string-matching) 