...
# [2407. Longest Increasing Subsequence II](https://leetcode.cn/problems/longest-increasing-subsequence-ii)
 ### Description
...
**Related Topics**  [Binary Indexed Tree](https://leetcode.cn/tag/binary-indexed-tree) [Segment Tree](https://leetcode.cn/tag/segment-tree) [Queue](https://leetcode.cn/tag/queue) [Array](https://leetcode.cn/tag/array) [Divide and Conquer](https://leetcode.cn/tag/divide-and-conquer) [Dynamic Programming](https://leetcode.cn/tag/dynamic-programming) [Monotonic Queue](https://leetcode.cn/tag/monotonic-queue) 