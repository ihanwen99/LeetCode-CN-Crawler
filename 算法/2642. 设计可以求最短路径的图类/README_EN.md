...
# [2642. Design Graph With Shortest Path Calculator](https://leetcode.cn/problems/design-graph-with-shortest-path-calculator)
 ### Description
...
**Related Topics**  [Graph](https://leetcode.cn/tag/graph) [Design](https://leetcode.cn/tag/design) [Shortest Path](https://leetcode.cn/tag/shortest-path) [Heap (Priority Queue)](https://leetcode.cn/tag/heap-priority-queue) 