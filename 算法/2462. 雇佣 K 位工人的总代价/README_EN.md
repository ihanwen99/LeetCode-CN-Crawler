...
**Related Topics**  [Array](https://leetcode.cn/tag/array) [Two Pointers](https://leetcode.cn/tag/two-pointers) [Simulation](https://leetcode.cn/tag/simulation) [Heap (Priority Queue)](https://leetcode.cn/tag/heap-priority-queue) 