...
# [2357. Make Array Zero by Subtracting Equal Amounts](https://leetcode.cn/problems/make-array-zero-by-subtracting-equal-amounts)
 ### Description
...
**Related Topics**  [Greedy](https://leetcode.cn/tag/greedy) [Array](https://leetcode.cn/tag/array) [Hash Table](https://leetcode.cn/tag/hash-table) [Sorting](https://leetcode.cn/tag/sorting) [Simulation](https://leetcode.cn/tag/simulation) [Heap (Priority Queue)](https://leetcode.cn/tag/heap-priority-queue) 