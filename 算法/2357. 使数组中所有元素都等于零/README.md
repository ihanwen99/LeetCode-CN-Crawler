...
**标签:**  [贪心](https://leetcode.cn/tag/greedy) [数组](https://leetcode.cn/tag/array) [哈希表](https://leetcode.cn/tag/hash-table) [排序](https://leetcode.cn/tag/sorting) [模拟](https://leetcode.cn/tag/simulation) [堆（优先队列）](https://leetcode.cn/tag/heap-priority-queue) 
# 解题思路 √
