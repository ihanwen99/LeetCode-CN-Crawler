...
**Related Topics**  [Design](https://leetcode.cn/tag/design) [Queue](https://leetcode.cn/tag/queue) [Array](https://leetcode.cn/tag/array) [Linked List](https://leetcode.cn/tag/linked-list) [Data Stream](https://leetcode.cn/tag/data-stream) 