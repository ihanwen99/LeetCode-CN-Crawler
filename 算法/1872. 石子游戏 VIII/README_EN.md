...
**Related Topics**  [Array](https://leetcode.cn/tag/array) [Math](https://leetcode.cn/tag/math) [Dynamic Programming](https://leetcode.cn/tag/dynamic-programming) [Game Theory](https://leetcode.cn/tag/game-theory) [Prefix Sum](https://leetcode.cn/tag/prefix-sum) 