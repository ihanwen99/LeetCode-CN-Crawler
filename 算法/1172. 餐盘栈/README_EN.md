...
**Related Topics**  [Stack](https://leetcode.cn/tag/stack) [Design](https://leetcode.cn/tag/design) [Hash Table](https://leetcode.cn/tag/hash-table) [Heap (Priority Queue)](https://leetcode.cn/tag/heap-priority-queue) 