...
**标签:**  [栈](https://leetcode.cn/tag/stack) [设计](https://leetcode.cn/tag/design) [哈希表](https://leetcode.cn/tag/hash-table) [堆（优先队列）](https://leetcode.cn/tag/heap-priority-queue) 