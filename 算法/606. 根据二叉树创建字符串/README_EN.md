...
**Related Topics**  [Tree](https://leetcode.cn/tag/tree) [Depth-First Search](https://leetcode.cn/tag/depth-first-search) [String](https://leetcode.cn/tag/string) [Binary Tree](https://leetcode.cn/tag/binary-tree) 
