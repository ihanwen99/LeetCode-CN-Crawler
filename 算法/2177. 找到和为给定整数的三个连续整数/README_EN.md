...
# [2177. Find Three Consecutive Integers That Sum to a Given Number](https://leetcode.cn/problems/find-three-consecutive-integers-that-sum-to-a-given-number)
 ### Description
...
**Related Topics**  [Math](https://leetcode.cn/tag/math) [Simulation](https://leetcode.cn/tag/simulation) 