...
**标签:**  [栈](https://leetcode.cn/tag/stack) [数组](https://leetcode.cn/tag/array) [二分查找](https://leetcode.cn/tag/binary-search) [有序集合](https://leetcode.cn/tag/ordered-set) [单调栈](https://leetcode.cn/tag/monotonic-stack) 
# 解题思路 √
