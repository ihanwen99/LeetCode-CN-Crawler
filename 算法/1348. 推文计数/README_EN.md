...
**Related Topics**  [Design](https://leetcode.cn/tag/design) [Hash Table](https://leetcode.cn/tag/hash-table) [Binary Search](https://leetcode.cn/tag/binary-search) [Ordered Set](https://leetcode.cn/tag/ordered-set) [Sorting](https://leetcode.cn/tag/sorting) 