...
**Related Topics**  [Greedy](https://leetcode.cn/tag/greedy) [Queue](https://leetcode.cn/tag/queue) [Array](https://leetcode.cn/tag/array) [Binary Search](https://leetcode.cn/tag/binary-search) [Sorting](https://leetcode.cn/tag/sorting) [Monotonic Queue](https://leetcode.cn/tag/monotonic-queue) 