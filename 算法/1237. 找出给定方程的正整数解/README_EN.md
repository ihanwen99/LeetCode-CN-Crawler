...
# [1237. Find Positive Integer Solution for a Given Equation](https://leetcode.cn/problems/find-positive-integer-solution-for-a-given-equation)
 ### Description
...
**Related Topics**  [Math](https://leetcode.cn/tag/math) [Two Pointers](https://leetcode.cn/tag/two-pointers) [Binary Search](https://leetcode.cn/tag/binary-search) [Interactive](https://leetcode.cn/tag/interactive) 