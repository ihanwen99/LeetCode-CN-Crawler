...
**Related Topics**  [Geometry](https://leetcode.cn/tag/geometry) [Array](https://leetcode.cn/tag/array) [Math](https://leetcode.cn/tag/math) [Sorting](https://leetcode.cn/tag/sorting) [Sliding Window](https://leetcode.cn/tag/sliding-window) 