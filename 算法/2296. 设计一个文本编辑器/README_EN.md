...
**Related Topics**  [Stack](https://leetcode.cn/tag/stack) [Design](https://leetcode.cn/tag/design) [Linked List](https://leetcode.cn/tag/linked-list) [String](https://leetcode.cn/tag/string) [Doubly-Linked List](https://leetcode.cn/tag/doubly-linked-list) [Simulation](https://leetcode.cn/tag/simulation) 