...
# [2565. Subsequence With the Minimum Score](https://leetcode.cn/problems/subsequence-with-the-minimum-score)
 ### Description
...
**Related Topics**  [Two Pointers](https://leetcode.cn/tag/two-pointers) [String](https://leetcode.cn/tag/string) [Binary Search](https://leetcode.cn/tag/binary-search) 