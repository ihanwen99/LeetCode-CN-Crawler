...
# [1903. Largest Odd Number in String](https://leetcode.cn/problems/largest-odd-number-in-string)
 ### Description
...
**Related Topics**  [Greedy](https://leetcode.cn/tag/greedy) [Math](https://leetcode.cn/tag/math) [String](https://leetcode.cn/tag/string) 