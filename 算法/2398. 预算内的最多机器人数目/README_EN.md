...
# [2398. Maximum Number of Robots Within Budget](https://leetcode.cn/problems/maximum-number-of-robots-within-budget)
 ### Description
...
**Related Topics**  [Queue](https://leetcode.cn/tag/queue) [Array](https://leetcode.cn/tag/array) [Binary Search](https://leetcode.cn/tag/binary-search) [Prefix Sum](https://leetcode.cn/tag/prefix-sum) [Sliding Window](https://leetcode.cn/tag/sliding-window) [Heap (Priority Queue)](https://leetcode.cn/tag/heap-priority-queue) 