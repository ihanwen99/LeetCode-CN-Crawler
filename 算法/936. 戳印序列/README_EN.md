...
**Related Topics**  [Stack](https://leetcode.cn/tag/stack) [Greedy](https://leetcode.cn/tag/greedy) [Queue](https://leetcode.cn/tag/queue) [String](https://leetcode.cn/tag/string) 