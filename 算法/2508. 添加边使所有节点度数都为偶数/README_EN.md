...
# [2508. Add Edges to Make Degrees of All Nodes Even](https://leetcode.cn/problems/add-edges-to-make-degrees-of-all-nodes-even)
 ### Description
...
**Related Topics**  [Graph](https://leetcode.cn/tag/graph) [Hash Table](https://leetcode.cn/tag/hash-table) 