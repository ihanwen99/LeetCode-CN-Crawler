...
**标签:**  [栈](https://leetcode.cn/tag/stack) [广度优先搜索](https://leetcode.cn/tag/breadth-first-search) [字符串](https://leetcode.cn/tag/string) [回溯](https://leetcode.cn/tag/backtracking) 