...
**Related Topics**  [Stack](https://leetcode.cn/tag/stack) [Breadth-First Search](https://leetcode.cn/tag/breadth-first-search) [String](https://leetcode.cn/tag/string) [Backtracking](https://leetcode.cn/tag/backtracking) 
