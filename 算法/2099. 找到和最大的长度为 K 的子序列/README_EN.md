...
# [2099. Find Subsequence of Length K With the Largest Sum](https://leetcode.cn/problems/find-subsequence-of-length-k-with-the-largest-sum)
 ### Description
...
**Related Topics**  [Array](https://leetcode.cn/tag/array) [Hash Table](https://leetcode.cn/tag/hash-table) [Sorting](https://leetcode.cn/tag/sorting) [Heap (Priority Queue)](https://leetcode.cn/tag/heap-priority-queue) 