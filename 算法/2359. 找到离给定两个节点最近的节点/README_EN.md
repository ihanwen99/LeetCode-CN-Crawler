...
# [2359. Find Closest Node to Given Two Nodes](https://leetcode.cn/problems/find-closest-node-to-given-two-nodes)
 ### Description
...
**Related Topics**  [Depth-First Search](https://leetcode.cn/tag/depth-first-search) [Graph](https://leetcode.cn/tag/graph) 