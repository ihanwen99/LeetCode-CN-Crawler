...
**Related Topics**  [Segment Tree](https://leetcode.cn/tag/segment-tree) [Queue](https://leetcode.cn/tag/queue) [Array](https://leetcode.cn/tag/array) [Dynamic Programming](https://leetcode.cn/tag/dynamic-programming) [Prefix Sum](https://leetcode.cn/tag/prefix-sum) [Monotonic Queue](https://leetcode.cn/tag/monotonic-queue) [Heap (Priority Queue)](https://leetcode.cn/tag/heap-priority-queue) 