...
**标签:**  [设计](https://leetcode.cn/tag/design) [数组](https://leetcode.cn/tag/array) [哈希表](https://leetcode.cn/tag/hash-table) [有序集合](https://leetcode.cn/tag/ordered-set) [堆（优先队列）](https://leetcode.cn/tag/heap-priority-queue) 