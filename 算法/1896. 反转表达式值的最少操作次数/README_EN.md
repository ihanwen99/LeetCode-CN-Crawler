...
**Related Topics**  [Stack](https://leetcode.cn/tag/stack) [Math](https://leetcode.cn/tag/math) [String](https://leetcode.cn/tag/string) [Dynamic Programming](https://leetcode.cn/tag/dynamic-programming) 