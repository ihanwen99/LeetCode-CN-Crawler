...
**标签:**  [贪心](https://leetcode.cn/tag/greedy) [并查集](https://leetcode.cn/tag/union-find) [字符串](https://leetcode.cn/tag/string) [动态规划](https://leetcode.cn/tag/dynamic-programming) 