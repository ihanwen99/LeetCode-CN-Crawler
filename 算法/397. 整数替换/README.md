...
**标签:**  [贪心](https://leetcode.cn/tag/greedy) [位运算](https://leetcode.cn/tag/bit-manipulation) [记忆化搜索](https://leetcode.cn/tag/memoization) [动态规划](https://leetcode.cn/tag/dynamic-programming) 